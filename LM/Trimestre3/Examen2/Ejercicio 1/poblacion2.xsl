        ...
        <html>
            <body>
                ...
                <table border="1">
                    ...
                    <!-- Se muestran todos los valores -->
                    <xsl:for-each select="poblacion/provincia">
                        <!-- Tomando a Mujeres2017, se mostrarán los valores ordneados de manera ascendente de su población -->
                        <xsl:sort select="Mujeres2017" data-type="number" order="ascending"/>
                        <tr>
